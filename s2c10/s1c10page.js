  let result,cipher,encKey,plainText,aE,aD,cBits,padInfo,sweetDiv,tHelp,inputType,iV,ivHelper;
  function process(act) {
    ...
    //initialization vector validation
    if (!initV.length) {
    ...
    if (act==='encrypt') {
      ...
      Z=aesDecryptCBC(I,key,initV,bits);
  ...
  function selectors() {
    ...
    iV=document.querySelector('input#iV');
    ivHelper=document.querySelector('div#ivHelper');
  }
